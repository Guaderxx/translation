...
相关信息参考[附录：替代分析文件来源](https://github.com/Guaderxx/)
...
关于匹配和降级的更多详细信息，参见[源稳定性](https://go.dev/doc/pgo#source-stability)部分。
...
也就是说，[上面](https://go.dev/doc/pgo#autofdo)讨论的源稳定性警告也适用于此。
